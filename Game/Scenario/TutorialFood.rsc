StringTable tutorialStrings
{
	Entry _strings
	[
		{ String _name = "Step_Begin_0_Pre";			String _text = "Es gibt viele Wege Narungsmittel für die Einwohner deiner Stadt zu produzieren.~n~nJagen, Angeln, und Sammeln können can be used to harvest food from the environment, or you can clear the land and plant orchards, grow crops, and raise livestock."; }
